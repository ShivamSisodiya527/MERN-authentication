        ...
        <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400'>
            ...
            {/* {isOtpVerified ? (
                <form className="bg-white p-8 rounded-lg shadow-lg w-96">
                    ...
                    <input type="password" placeholder="New Password" className="w-full mb-4 p-2 border rounded" />
                    <input type="password" placeholder="Confirm Password" className="w-full mb-4 p-2 border rounded" />
                    <button className="w-full bg-indigo-600 text-white py-2 rounded">Set Password</button>
                </form>
            ) : ( */}
